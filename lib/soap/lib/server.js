...
Server.prototype._executeMethod = function(options, callback) {
    ...
    try {
        console.log('[SOAP-Lib] serviceName: ' + serviceName);
        console.log('[SOAP-Lib] portName: ' + portName);
        console.log('[SOAP-Lib] methodName: ' + methodName);
        method = this.services[serviceName][portName][methodName];
        console.log('[SOAP-LIB] method: ' + JSON.stringify(this.services));
    } catch(e) {
